...
graph TD
    ...
    CommandDetect -->|"ALIGN"| ALIGN["ALIGN Mode"]
    ...
    ALIGN --> AlignResp["Respond: OK ALIGN"]
    ...
    AlignResp --> CheckMB_Align["Check Memory Bank<br>& activeContext.md Status"]
    ...
    CheckMB_Align --> LoadAlign["Load ALIGN Mode<br>Instructions"]
    ...
    LoadAlign --> ExecAlign["Execute ALIGN<br>Process"]
    ...
    ExecAlign --> UpdateMB_Align["Update Memory Bank<br>& activeContext.md"]
    ...
    UpdateMB_Align --> VerifyAlign{"Process<br>Complete?"}
    ...
    VerifyAlign -->|"Yes"| CompleteAlign["ALIGN Process<br>Complete"]
    VerifyAlign -->|"No"| RetryAlign["Resume<br>ALIGN Process"]
    RetryAlign --- ReadMB_Align["Reference Memory Bank<br>for Context"]
    ReadMB_Align --> ExecAlign
    ...
    CompleteAlign --> FinalMB_Align["Update Memory Bank<br>with Completion Status"]
    ...
    FinalMB_Van -->|"Level 2-4"| TransToAlign["→ ALIGN Mode"]
    FinalMB_Align --> TransToPlan["→ PLAN Mode"]
    ...
    CheckMB_Van & CheckMB_Align & CheckMB_Plan & CheckMB_Creative & CheckMB_Impl & CheckMB_QA -.-> MemoryBank
    UpdateMB_Van & UpdateMB_Align & UpdateMB_Plan & UpdateMB_Creative & UpdateMB_Impl & UpdateMB_QA -.-> MemoryBank
    ReadMB_Van & ReadMB_Align & ReadMB_Plan & ReadMB_Creative & ReadMB_Impl & ReadMB_QA -.-> MemoryBank
    FinalMB_Van & FinalMB_Align & FinalMB_Plan & FinalMB_Creative & FinalMB_Impl & FinalMB_QA -.-> MemoryBank
